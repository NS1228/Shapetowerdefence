  ...
  //  public float rrange = 1f;
    ...
    void OnMouseDown()
    {
      ...
      
        {
            ...
            if (sshoper.GetComponent<Shop>().coins >= 50)
            {
                GameObject turreToBuild = BuildManager.instance.GetTurretToBuild();
                turret = (GameObject)Instantiate(turreToBuild, transform.position, transform.rotation);
                thisobj.SetActive(false);
                sshoper.GetComponent<Shop>().coins -= 50;

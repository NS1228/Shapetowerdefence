...
public class Heartscript : MonoBehaviour {
    ...
    void Shoot()
    {
        ...
        GameObject bulletGO2 = (GameObject)Instantiate(bulletPrefab, firePointtwo.position, firePointtwo.rotation);
        GameObject bulletGO3 = (GameObject)Instantiate(bulletPrefab, firePointthree.position, firePointthree.rotation);
